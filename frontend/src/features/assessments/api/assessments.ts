...
export const assessmentsApi = {
  ...
  create: (input: AssessmentInput) =>
    request<Assessment>('/assessments', { method: 'POST', body: JSON.stringify(input) }),
  update: (id: string, input: AssessmentInput) =>
    request<Assessment>(`/assessments/${id}`, { method: 'PUT', body: JSON.stringify(input) }),
